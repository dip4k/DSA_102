...
| :--- | :--- | :--- | :--- |
| **1. OOP & Object Modeling** | 🔴 Critical | Classes, objects, encapsulation, abstraction, polymorphism, composition, class relationships (Association, Aggregation, Composition, Dependency), UML class diagrams | [01. OOP & SOLID](./00_Core_Concepts/01_OOP_and_SOLID.md) · [09. UML Class Diagrams](./00_Core_Concepts/09_UML_Class_Diagrams.md) |
| **2. SOLID & Design Principles** | 🔴 Critical | SOLID, cohesion/coupling, DRY, KISS, YAGNI, composition over inheritance | [01. OOP & SOLID](./00_Core_Concepts/01_OOP_and_SOLID.md) |
...
## 🚀 The 31-Problem Interview Portfolio

Mastering these 31 problems exercises every core pattern across production scenarios.
...
| Pattern / Concept | Parking | Booking | Cache | Notify | Order | Message | Wallet | Exchange | Locker | Auction | Library | ATM | Hotel | TaskMgmt |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Encapsulation** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| **Composition**   | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| **SOLID**         | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
