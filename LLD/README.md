...
* [01. OOP & SOLID Principles](./00_Core_Concepts/01_OOP_and_SOLID.md)
* [02. Design Patterns (The 80/20 Cheat Sheet)](./00_Core_Concepts/02_Design_Patterns_Cheat_Sheet.md)
...
1. [Meeting Room Booking (Concurrency)](./01_Tier1_Highest_Priority/01_Meeting_Room_Booking.md)
2. [Generic Message Processor (Factory + DI)](./01_Tier1_Highest_Priority/02_Generic_Message_Processor.md)
3. [DDD Order Management (CQRS)](./01_Tier1_Highest_Priority/03_DDD_Order_Management.md)
...
14. [Ride-Hailing System (Uber / Ola)](./02_Tier2_Classic_LLD/20_Ride_Hailing_System.md)
