# 📖 README_v9.1_QUALITY_STANDARDS.md — Updated Curriculum Guide

**Version:** 9.1 (with Unified Quality Standards)  
...
✅ **TEMPLATE_v9.1.md** — Enhanced template with complete operations coverage  
✅ **Cognitive Lenses** — Mandatory 5-perspective block (800-1200 words)  
✅ **Operations Coverage** — ALL core operations must be listed and covered  
✅ **Word Count Standards** — Precise ranges for each section (7,500-15,000 total)  
✅ **Quality Checklist** — Comprehensive pre-submission verification  
✅ **Code Policy** — C# only when necessary; logic-first approach  
✅ **Mermaid Diagrams** — Preferred over ASCII for complex flows  
...
- **Why:** Focus on concepts, not syntax
...
├── SYSTEM_CONFIG_v9.1.md          [Global standards]
├── SYSTEM_PROMPT_v9.1_FOR_AI.md   [AI prompt]
├── README_v9.1.md                 [This file]
...
- **How to generate?** → MASTER_PROMPT_v9.1.md
- **What's the standard?** → SYSTEM_CONFIG_v9.1.md
- **What should I write?** → TEMPLATE_v9.1.md
- **For AI generation?** → SYSTEM_PROMPT_v9.1_FOR_AI.md
- **Icon/emoji usage?** → EMOJI_ICON_GUIDE_v8.md
