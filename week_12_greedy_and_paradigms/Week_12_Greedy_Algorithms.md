...
Greedy gave 2, which is still better, but...

Actually try to make $0.13:
Greedy: 6¢ + 6¢ = $0.12 (NOT ENOUGH)
        6¢ + 6¢ + 1¢ = $0.13 → 3 coins
Optimal: 4¢ + 4¢ + 4¢ + 1¢ = $0.13 → 4 coins

Actually greedy was better here too!
But the point: greedy is NOT always optimal for all coin systems.
```
...
## 🎓 CONCEPT: Greedy Algorithm Template
...
GREEDY_ALGORITHM(problem):
  ...
  3. Initialize solution = empty
  4. For each item in sorted order:
       If item can be added to solution:
           Add item to solution
  5. Return solution

PROVE_CORRECTNESS():
  1. Show problem has optimal substructure
  2. Show problem has greedy choice property
  3. Show greedy choice leaves subproblem
  4. Use induction to complete proof
```

---

## 🎓 CONCEPT: Exchange Argument (Correctness Proof)
...
Pick A₄ [6,9]? No, conflicts with A₃
...
## 🎓 CONCEPT: The Activity Selection Problem
...
## 🎓 CONCEPT: Greedy Solution (Correct!)
...
## 🎓 CONCEPT: Interval Problem Variations
...
## 🎓 CONCEPT: Prefix Codes and Huffman Coding
...
## 🎓 CONCEPT: Why Huffman is Optimal
...
## 🎓 CONCEPT: Optimality of Prefix Codes
...
## 🎓 CONCEPT: Fractional Knapsack Algorithm
...
## 🎓 CONCEPT: Why Greedy Works for Fractional
...
## 🎓 CONCEPT: Job Sequencing with Deadlines
...
## 🎓 CONCEPT: Greedy Solution for Job Sequencing
...
Maximum Spanning Tree:   ✗ Greedy works (similar to MST)
