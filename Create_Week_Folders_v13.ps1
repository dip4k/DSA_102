...
$weekFolders = [ordered]@{
    ...
    "week_04_core_patterns_i"                                                       = "Week 4: Core Problem-Solving Patterns I"
    "week_05_tier1_critical_patterns"                                               = "Week 5: Tier 1 Critical Patterns ⭐"
    "week_06_string_patterns"                                                       = "Week 6: String Manipulation Patterns"
    "week_07_trees_and_balanced_bsts"                                               = "Week 7: Trees & Balanced Search Trees"
    ...
    "week_10_dp_i_fundamentals"                                                     = "Week 10: Dynamic Programming I - Fundamentals"
